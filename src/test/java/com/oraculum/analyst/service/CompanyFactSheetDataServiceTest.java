...
class CompanyFactSheetDataServiceTest {
    ...
    void create_returnsPopulatedFactSheet() {
        ...
        // The following getters return Strings generated by objectMapper (which we mocked to return "[]" or "{}")
        // but wait, some are accessed via custom getters. Let's just assert the fields exist via reflection or that the methods don't throw NPE.
