...
class LlmRouterServiceImplTest {
    ...
    void testAllProvidersFailThrowsException() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> routerService.generate(LlmTierType.STANDARD, "prompt", String.class));
    ...
    void testMissingTierConfigurationThrowsException() {
        ...
        routerService = new LlmRouterServiceImpl(Map.of(LlmProviderType.OPENAI, openaiClient), executionService,
                health, propertiesWithMissingTier);
