...
public class PlannerAgentService implements AgentService<PlannerPlan> {
    ...
    public PlannerAgentService(LlmRouterApi llmRouterApi, AgentDataTools agentDataTools, PromptRegistry registry) {
        this.llmRouterApi = llmRouterApi;
        this.agentDataTools = agentDataTools;
    ...
    public AgentOutput<PlannerPlan> run(AgentContext ctx) {
        ...
        String sharePriceSignals = agentDataTools.getSharePriceSignals(company.id(), ctx.requestDate());
