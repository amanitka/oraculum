...
3.  **Incorporate Macroeconomic Context**: A Chief Economist has provided a `macroeconomic_context` briefing. Consider how the current macroeconomic regime (especially interest rates, which dictate cost of capital) impacts your DCF assumptions and the acceptable multiples for this company. Use this strictly as background context, not as the main driver for your valuation result.
