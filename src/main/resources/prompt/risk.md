...
5.  `share_price_analysis`: The analysis generated by the Share Price Agent, including current momentum, valuation multiples, and price signals.
6.  `fundamentals_analysis`: The analysis generated by the Fundamentals Agent.
7.  `cash_flow_analysis`: The analysis generated by the Cash Flow Agent.
8.  `macroeconomic_context`: The macroeconomic regime briefing generated by the Chief Economist.
